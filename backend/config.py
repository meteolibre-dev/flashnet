...
class ModelConfig(BaseModel):
    """Model configuration."""
    model_path: str = "models/20251019_epoch61_mtg_lightning_soap.safetensors"
    model_type: str = "jit"
    patch_size: int = 128
...
class Config(BaseModel):
    ...
    def from_env(cls) -> "Config":
        ...
        return cls(
            ...
            model=ModelConfig(
                model_path=os.getenv("MODEL_PATH", "models/20251019_epoch61_mtg_lightning_soap.safetensors"),
